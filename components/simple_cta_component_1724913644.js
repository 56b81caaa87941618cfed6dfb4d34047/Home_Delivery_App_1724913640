...
-->
<template>
    <section id="cta-component" style="min-height: 510px"  class="bg-gradient-to-br from-pink-400 to-purple-600 flex-1 min-h-350px p-8" style=""><div id="cta-inner-container" class="max-w-screen-xl mx-auto bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg p-8" style="" data-mf-new="true"><div id="cta-content" class="max-w-screen-sm mx-auto text-center"><div id="cta-title-container" class="flex mb-4"><h2 id="cta-title" class="flex-1 text-3xl font-extrabold leading-tight tracking-tight text-white">
